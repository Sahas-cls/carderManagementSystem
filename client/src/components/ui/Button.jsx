const VARIANTS = {
  default: "bg-white border border-slate-300 text-navy-dark hover:bg-slate-50 hover:border-slate-400 hover:text-navy",
  ...
  delete: "bg-white border border-slate-300 text-red-600 hover:bg-red-50 hover:border-red-300 hover:text-red-700",
};

/** Shared action button - pass `variant` to match the mockup's color-coded buttons. */
export default function Button({ variant = "default", small = false, className = "", ...props }) {
  return (
    <button
      type="button"
